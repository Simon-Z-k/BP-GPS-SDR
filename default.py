...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Podělaná GPS", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Podělaná GPS")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 5115100
        ...
        self.epy_block_1 = epy_block_1.blk(sat_id=1, sample_rate=1023000)
        self.blocks_xor_xx_0 = blocks.xor_ss()
        ...
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_float*1, 5)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 5)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, 'C:\\Users\\simon\\Desktop\\BP\\brdc0010.22n', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.analog_sig_source_x_0 = analog.sig_source_f(8000000, analog.GR_SIN_WAVE, 1.57542e9, 1, 0, 0)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.blocks_xor_xx_0, 0))
        ...
        self.connect((self.blocks_short_to_float_0, 0), (self.blocks_repeat_0_0, 0))
        self.connect((self.blocks_short_to_float_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.blocks_xor_xx_0, 0), (self.blocks_short_to_float_0, 0))
        self.connect((self.epy_block_1, 0), (self.blocks_short_to_float_0_0, 0))
        self.connect((self.epy_block_1, 0), (self.blocks_xor_xx_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(1.57542e9, self.samp_rate)
